package com.prahlad.TestHazelcastJET;
...
public class WordCount {
    public static void main(String[] args) throws Exception {
        // Create the specification of the computation pipeline. Note that
        // it is a pure POJO: no instance of Jet is needed to create it.
        Pipeline p = PipelineImpl.class.newInstance();
        p.drawFrom(Sources.<String>list("text"))
         .flatMap(word -> traverseArray(
             word.toLowerCase().split("\\W+")))
