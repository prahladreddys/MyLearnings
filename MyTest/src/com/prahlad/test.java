...
public class test {
	public static void main(String[] args) throws Exception {
		...
		String s = "ILovePranav";
		String s1 = s.substring(7);
		System.out.println(s);
		System.out.println(s1);
		
		// Lets see what inside s
		Field innerChArray = String.class.getDeclaredField("value");
		innerChArray.setAccessible(true);
		char[] chars = (char[]) innerChArray.get(s);
		System.out.println(Arrays.toString(chars));
		
		chars = (char[])innerChArray.get(s1);
		System.out.println(Arrays.toString(chars));
		meth();
	}
